...
function addReports(myBlobObj, output_id) {
    var _a, _b;
    return `INSERT INTO [dbo].reports VALUES (${output_id}, ${parsePotentiallyGroupedFloat(myBlobObj.output_date)}, ${myBlobObj.output_alg_version}, ${((_a = myBlobObj.patient) === null || _a === void 0 ? void 0 : _a.dob) || 0}, '${((_b = myBlobObj.patient) === null || _b === void 0 ? void 0 : _b.gender) || 'U'}', ${parsePotentiallyGroupedFloat(myBlobObj.event_date)}, '${myBlobObj.output_id}')`;
}
function addAttributes(myBlobObj, attribute, output_id) {
    if (!myBlobObj[attribute])
        return '';
