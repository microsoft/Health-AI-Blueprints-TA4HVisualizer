...
Create new secret and copy its value
Add "Fhir Contributor" Role for created "App regestration" in "ta4h Fhir Service" resource
...
Post actions:
Go to new created function.
Open configuration
Change value of Audience to  https://visualizer-ta4h.fhir.azurehealthcareapis.com
Change value of AzureWebJobsStorage to a connection string taken from storage "fhirstorageXXX"
Press Save and wait for approval
